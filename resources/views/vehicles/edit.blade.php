              ...
              <div class="col-md-8 order-md-1">
                <div class="row">
                  <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="vehicles_name" name="vehicles_name" placeholder="" value="{{ $vehicle->vehicles_name }}" required>
                  </div>
                  <div class="col-md-6 mb-3">
                    <label for="sobrenome">Código Fipe</label>
                    <input type="text" class="form-control" id="code" name="fipe_code" placeholder="" value="{{ $vehicle->fipe_code }}" required>
                  </div>
                </div>
              </div>
              <div class="col-md-8 order-md-1">
                <div class="row">
                  <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="price" name="price" placeholder="" value="{{ $vehicle->price }}" required>
                  </div>
                </div>
              </div>
              <div class="col-md-8 order-md-1">
